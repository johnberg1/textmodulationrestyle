...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--checkpoint_path', default=None, type=str,
                                 help='Path to training checkpoint containing mapper')
        self.parser.add_argument('--restyle_path', default="pretrained_models/restyle_e4e_ffhq_encode.pt", type=str,
                                 help='Path to pre-trained ReStyle model checkpoint')
